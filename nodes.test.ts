...
let cases: [string, Result][] = [
  ...
  ['1 usd in rub', new Numbr(2, 'RUB' as CurrencyCode)],
  ['100 + 25% in rub', new Numbr(125, 'RUB' as CurrencyCode)],
  ['100 рублей в долларах', new Numbr(50, 'USD' as CurrencyCode)],
  ['100 in thb + 50% in income + 300', new Numbr(450, 'THB' as CurrencyCode)],
  ['100 - 100 in rub + (3 usd in rub) / 3 in rub', new Numbr(2, 'RUB' as CurrencyCode)],
  ['100 usd in rub + 300% / 3 in rub', new Numbr(400, 'RUB' as CurrencyCode)],
  ...
  ['5% of 100$', new Numbr(5, 'USD' as CurrencyCode)],
]
